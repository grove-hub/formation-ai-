...
class TextScrapper():
    def __init__(self, url):
        ...
        # fichier des pdf
        self.raw_pdf = os.path.join(self.project_root, "data", "raw_pdfs")
        # fichier sortie
        self.output_folder = os.path.join(self.project_root, "data", "before_clean_data")
        # fichier pour les entierement pret
        self.final_folder = os.path.join(self.project_root, "data", "clean_data")
